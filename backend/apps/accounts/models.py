...
class AuditLog(models.Model):
    ...
    class Action(models.TextChoices):
        ...
        JUSTIF_CREATE = "justif_create", "Ajout d'un justificatif"
        JUSTIF_UPDATE = "justif_update", "Modification d'un justificatif"
        JUSTIF_DELETE = "justif_delete", "Suppression d'un justificatif"
