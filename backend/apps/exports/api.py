...
def _get_activite_visible(activite_id: UUID) -> Activite:
    """Activité visible par tout compte authentifié, ou 404 si elle n'existe pas."""
...
def export_excel(
    ...
    activite = _get_activite_visible(activite_id)
